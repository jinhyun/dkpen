...
public class EappArchivePaperDTO {
    ...
    private List<EappArchiveLineDTO> eappLineDTOList;

    public List<EappArchiveLineDTO> getEappLineDTOList() {
        return eappLineDTOList;
    }

    public void setEappLineDTOList(List<EappArchiveLineDTO> eappLineDTOList) {
